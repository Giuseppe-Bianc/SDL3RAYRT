macro(SDL3RAYRT_enable_cppcheck WARNINGS_AS_ERRORS CPPCHECK_OPTIONS)
  ...
  if(CPPCHECK)
        ...
        message(STATUS "Cppcheck enabled with options: ${CMAKE_CXX_CPPCHECK}")
...
macro(SDL3RAYRT_enable_clang_tidy target WARNINGS_AS_ERRORS)
...
# Macro to enable include-what-you-use
macro(SDL3RAYRT_enable_include_what_you_use)
